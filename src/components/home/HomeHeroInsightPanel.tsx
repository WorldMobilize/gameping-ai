...
export default function HomeHeroInsightPanel() {
  return (
    <div className="gp-home-insight w-full min-w-0">
      <div className="gp-home-insight-card overflow-hidden rounded-2xl border border-white/10 bg-[#070a12]/70 shadow-[0_20px_60px_-24px_rgba(0,0,0,0.7)] backdrop-blur-sm transition-transform duration-500 hover:-translate-y-0.5">
        <div className="border-b border-white/[0.06] bg-black/20 px-4 py-3 min-[960px]:px-5">
        ...
        <div className="space-y-4 p-4 min-[960px]:p-5">
          ...
          <div className="rounded-xl border border-sky-400/20 bg-sky-400/[0.07] p-3.5">
