...
export default function HomeHeroInsightPanel() {
  return (
    <div className="gp-home-insight w-full min-w-0">
      <div className="overflow-hidden rounded-2xl border border-white/[0.08] bg-[#0a0d14]/90 shadow-[0_20px_60px_-24px_rgba(0,0,0,0.65)]">
        <div className="border-b border-white/[0.06] bg-black/20 px-4 py-3 backdrop-blur-sm min-[960px]:px-5">
