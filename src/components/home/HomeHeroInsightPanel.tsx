...
export default function HomeHeroInsightPanel() {
  return (
    <div className="gp-home-insight w-full min-w-0">
      <div className="gp-home-insight-card overflow-hidden rounded-2xl border border-white/[0.1] bg-[#0a0d14]/50 shadow-[0_20px_60px_-24px_rgba(0,0,0,0.65)] backdrop-blur-md transition-transform duration-500 hover:-translate-y-0.5">
        <div className="border-b border-white/[0.06] bg-black/15 px-4 py-3 backdrop-blur-md min-[960px]:px-5">
        ...
        <div className="space-y-4 p-4 min-[960px]:p-5">
          ...
          <div className="rounded-xl border border-white/[0.08] bg-black/20 p-3.5 backdrop-blur-sm">
          ...
          <div className="rounded-xl border border-sky-400/20 bg-sky-400/[0.06] p-3.5 backdrop-blur-sm">
          ...
          <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-3.5 backdrop-blur-sm">
            <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-white/35">
              Output
            </p>
