  ...
  return (
    <section className="px-6 py-20 md:py-28" aria-labelledby="home-gaming-dna-heading">
      <div className="mx-auto max-w-6xl">
        <div className="grid overflow-hidden rounded-2xl border border-white/[0.08] bg-[#0a0d14] lg:grid-cols-2">
          <div className="p-8 md:p-12 lg:p-14">
            ...
            <p className="mt-4 max-w-md text-base leading-7 text-white/50">
              Connect your Steam library and GamePing learns the patterns behind your
            ...
            <Link
              ...
              className="mt-8 inline-flex rounded-xl border border-sky-400/30 bg-sky-400/10 px-6 py-3 text-sm font-semibold text-sky-100 transition hover:border-sky-400/45 hover:bg-sky-400/15 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400/40"
            >
              Connect Steam library
            </Link>
          </div>

          <div className="border-t border-white/[0.06] bg-[#06080f] p-8 md:p-10 lg:border-l lg:border-t-0">
            <div className="gp-home-dna-mock mx-auto max-w-md space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  {DNA_SIGNALS.map((signal) => (
                    <div
                      key={signal}
                      className="rounded-lg border border-white/[0.07] bg-black/30 px-3 py-2.5 text-xs font-medium text-white/60"
                    >
                      {signal}
                    </div>
                  ))}
