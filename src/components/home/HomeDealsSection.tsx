      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {HOME_DEAL_POINTS.map((point) => (
            <div
              key={point.title}
              className="gp-home-deal-card rounded-3xl border border-white/[0.08] bg-[#0a0d14]/70 p-6"
            >
        ...
        <div className="mt-8 rounded-3xl border border-white/[0.07] bg-black/25 p-5 md:p-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-baseline gap-3">
              ...
              <span className="text-2xl font-semibold tabular-nums text-cyan-300">$8.24</span>
