    ...
    <AppPageShell>
      <AppSection maxWidth="max-w-3xl">
        ...
        <div className={`mt-10 space-y-8 ${APP_BODY}`}>
          ...
          <div>
            <h2 className={APP_PROSE_HEADING}>1. The Service</h2>
            <p className="mt-3">
          ...
          <div>
            <h2 className={APP_PROSE_HEADING}>2. Eligibility</h2>
            <p className="mt-3">
          ...
          <div>
            <h2 className={APP_PROSE_HEADING}>3. AI outputs are probabilistic</h2>
            <p className="mt-3">
          ...
          <div>
            <h2 className={APP_PROSE_HEADING}>4. Prices, deals, and store availability</h2>
            <p className="mt-3">
          ...
          <div>
            <h2 className={APP_PROSE_HEADING}>5. Accounts and security</h2>
            <p className="mt-3">
          ...
          <div>
            <h2 className={APP_PROSE_HEADING}>6. Account deletion</h2>
            <p className="mt-3">
          ...
          <div>
            <h2 className={APP_PROSE_HEADING}>7. Premium subscription</h2>
            <p className="mt-3">
          ...
          <div>
            <h2 className={APP_PROSE_HEADING}>8. Acceptable use</h2>
          ...
          <div>
            <h2 className={APP_PROSE_HEADING}>9. Service availability</h2>
            <p className="mt-3">
          ...
          <div>
            <h2 className={APP_PROSE_HEADING}>10. Termination and suspension</h2>
            <p className="mt-3">
          ...
          <div>
            <h2 className={APP_PROSE_HEADING}>11. Intellectual property</h2>
            <p className="mt-3">
          ...
          <div>
            <h2 className={APP_PROSE_HEADING}>12. Disclaimers</h2>
            <p className="mt-3">
          ...
          <div>
            <h2 className={APP_PROSE_HEADING}>13. Limitation of liability</h2>
            <p className="mt-3">
          ...
          <div>
            <h2 className={APP_PROSE_HEADING}>14. Indemnification</h2>
            <p className="mt-3">
          ...
          <div>
            <h2 className={APP_PROSE_HEADING}>15. Governing law &amp; jurisdiction</h2>
            <p className="mt-3">
          ...
          <div>
            <h2 className={APP_PROSE_HEADING}>16. Changes</h2>
            <p className="mt-3">
